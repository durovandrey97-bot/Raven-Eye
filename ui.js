    ...
    <div style="width:100%;max-width:480px;max-height:93vh;overflow-y:auto;background:#0d1017;border-radius:24px 24px 0 0;padding:0 0 52px;scrollbar-width:none">
      ...
      <div style="padding:20px 20px 0">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:24px">
          ${[
            {n:'1',title:'Парсер находит арбитраж',desc:'Система сканирует пулы ликвидности в реальном времени и ищет разницу в цене одного актива на разных платформах',icon:'🔍'},
        ...
        <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:24px">
          ${[
            ...
            {icon:'💸',title:'Не переводите средства незнакомым',desc:'Парсер не требует переводить деньги на чужие кошельки. Все операции происходят внутри платформы'},
