...
function openEarnMore(){
  ...
  modal.style.cssText = 'position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.8);backdrop-filter:blur(10px);display:flex;align-items:flex-end;justify-content:center;animation:fadeIn .2s ease';
  modal.innerHTML = `
    <div style="width:100%;max-width:480px;max-height:93vh;overflow-y:auto;background:#0f1118;border-radius:22px 22px 0 0;padding:0 0 48px;scrollbar-width:none">

      <!-- Хедер -->
      <div style="position:sticky;top:0;z-index:10;background:#0f1118;padding:16px 20px 13px;border-bottom:1px solid rgba(255,255,255,.06);display:flex;align-items:center;justify-content:space-between">
      ...
      <div style="padding:20px 20px 0">
        ...
        <!-- ROI баннер -->
        <div style="background:linear-gradient(135deg,rgba(212,175,55,.2),rgba(212,175,55,.04));border:1px solid rgba(212,175,55,.35);border-radius:18px;padding:20px;margin-bottom:24px;text-align:center;position:relative;overflow:hidden">
          <div style="position:absolute;top:-30px;right:-30px;width:120px;height:120px;border-radius:50%;background:rgba(212,175,55,.06)"></div>
          <div style="font-size:10px;font-family:'JetBrains Mono',monospace;color:rgba(212,175,55,.6);letter-spacing:2.5px;margin-bottom:8px">RAVENEYE · DEX SCANNER PLATFORM</div>
          <div style="font-size:36px;font-weight:800;color:#d4af37;letter-spacing:-.02em;margin-bottom:4px">+1 132.9% ROI</div>
          <div style="font-size:13px;color:rgba(255,255,255,.45)">за 60 дней · CRYPTO SWAP стратегия</div>
        </div>

        <!-- ВВОДНЫЙ БЛОК — как растёт прибыль -->
        <div style="margin-bottom:24px">
          ...
          <div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);border-radius:16px;padding:16px;margin-bottom:10px">
            <div style="font-size:13px;color:rgba(255,255,255,.6);line-height:1.7">
              Парсер RavenEye работает на нескольких блокчейн-сетях одновременно. Чем больше ваш капитал — тем больше сетей открывается, тем больше сигналов вы получаете и тем выше ваш итоговый доход.
            </div>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:8px">
            ...
            <!-- BNB Chain — стартовая -->
            <div style="background:rgba(240,185,11,.06);border:1px solid rgba(240,185,11,.25);border-radius:14px;padding:14px;display:flex;align-items:center;gap:12px">
              <div style="width:40px;height:40px;border-radius:12px;background:rgba(240,185,11,.15);border:1px solid rgba(240,185,11,.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">🟡</div>
              <div style="flex:1">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
                  <span style="font-size:14px;font-weight:700;color:#F0B90B">BNB Chain</span>
                  <span style="font-size:9px;background:rgba(29,185,84,.15);border:1px solid rgba(29,185,84,.3);color:#1db954;padding:1px 7px;border-radius:20px;font-weight:700">СТАРТ</span>
                </div>
                <div style="font-size:11px;color:rgba(255,255,255,.4)">Доступна сразу · 1–3 сделки в день</div>
                <div style="font-size:11px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:2px">от $0 · объёмы $5M–40M</div>
              </div>
              <div style="text-align:right;flex-shrink:0">
                <div style="font-size:14px;font-weight:700;color:#F0B90B">~4%</div>
            ...
            <div style="display:flex;align-items:center;gap:8px;padding:0 16px">
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.05),rgba(255,255,255,.12))"></div>
              <div style="font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace">капитал растёт</div>
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.12),rgba(255,255,255,.05))"></div>
            </div>

            <!-- Arbitrum -->
            <div style="background:rgba(41,182,246,.06);border:1px solid rgba(41,182,246,.22);border-radius:14px;padding:14px;display:flex;align-items:center;gap:12px">
              <div style="width:40px;height:40px;border-radius:12px;background:rgba(41,182,246,.15);border:1px solid rgba(41,182,246,.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">🔷</div>
              <div style="flex:1">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
                  <span style="font-size:14px;font-weight:700;color:#29B6F6">Arbitrum</span>
                  <span style="font-size:9px;background:rgba(41,182,246,.15);border:1px solid rgba(41,182,246,.3);color:#29B6F6;padding:1px 7px;border-radius:20px;font-weight:700">от $10K</span>
                </div>
                <div style="font-size:11px;color:rgba(255,255,255,.4)">+2–3 сигнала в день</div>
                <div style="font-size:11px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:2px">объёмы $3M–30M · низкий gas</div>
              </div>
              <div style="text-align:right;flex-shrink:0">
                <div style="font-size:14px;font-weight:700;color:#29B6F6">~5%</div>
                <div style="font-size:9px;color:rgba(255,255,255,.3)">в день</div>
              </div>
            </div>
            ...
            <div style="display:flex;align-items:center;gap:8px;padding:0 16px">
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.05),rgba(255,255,255,.12))"></div>
              <div style="font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace">ещё больше возможностей</div>
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.12),rgba(255,255,255,.05))"></div>
            </div>

            <!-- Ethereum -->
            <div style="background:rgba(99,102,241,.06);border:1px solid rgba(99,102,241,.22);border-radius:14px;padding:14px;display:flex;align-items:center;gap:12px">
              <div style="width:40px;height:40px;border-radius:12px;background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">💎</div>
              <div style="flex:1">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
                  <span style="font-size:14px;font-weight:700;color:#818CF8">Ethereum</span>
                  <span style="font-size:9px;background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.3);color:#818CF8;padding:1px 7px;border-radius:20px;font-weight:700">от $20K</span>
                </div>
                <div style="font-size:11px;color:rgba(255,255,255,.4)">+1–2 сделки в день</div>
                <div style="font-size:11px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:2px">объёмы $8M–50M · max доходность</div>
              </div>
              <div style="text-align:right;flex-shrink:0">
                <div style="font-size:14px;font-weight:700;color:#818CF8">~6%</div>
                <div style="font-size:9px;color:rgba(255,255,255,.3)">в день</div>
              </div>
            </div>
            ...
            <div style="display:flex;align-items:center;gap:8px;padding:0 16px">
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.05),rgba(255,255,255,.12))"></div>
              <div style="font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace">финальный уровень</div>
              <div style="flex:1;height:1px;background:linear-gradient(90deg,rgba(255,255,255,.12),rgba(255,255,255,.05))"></div>
            </div>

            <!-- Solana -->
            <div style="background:rgba(153,69,255,.06);border:1px solid rgba(153,69,255,.22);border-radius:14px;padding:14px;display:flex;align-items:center;gap:12px">
              <div style="width:40px;height:40px;border-radius:12px;background:rgba(153,69,255,.15);border:1px solid rgba(153,69,255,.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px">🟣</div>
              <div style="flex:1">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
                  <span style="font-size:14px;font-weight:700;color:#9945FF">Solana</span>
                  <span style="font-size:9px;background:rgba(153,69,255,.15);border:1px solid rgba(153,69,255,.3);color:#9945FF;padding:1px 7px;border-radius:20px;font-weight:700">от $15K</span>
                </div>
                <div style="font-size:11px;color:rgba(255,255,255,.4)">+1–2 сделки в день</div>
                <div style="font-size:11px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:2px">объёмы $2M–25M · gas ≈ $0</div>
              </div>
              <div style="text-align:right;flex-shrink:0">
                <div style="font-size:14px;font-weight:700;color:#9945FF">~5.5%</div>
                <div style="font-size:9px;color:rgba(255,255,255,.3)">в день</div>
              </div>
            </div>
        ...
        <!-- Итог прогрессии -->
        <div style="background:linear-gradient(135deg,rgba(29,185,84,.1),rgba(29,185,84,.03));border:1px solid rgba(29,185,84,.2);border-radius:14px;padding:14px;margin-bottom:24px;display:flex;align-items:center;gap:12px">
          <div style="font-size:28px">📈</div>
          <div>
            <div style="font-size:13px;font-weight:700;color:#1db954;margin-bottom:3px">Больше сетей = больше сигналов = больше прибыли</div>
            <div style="font-size:12px;color:rgba(255,255,255,.45);line-height:1.5">На 4 сетях одновременно парсер генерирует до <b style="color:#fff">10 сделок в день</b> — в зависимости от вашего капитала</div>
            <div style="font-size:11px;color:rgba(255,255,255,.25);margin-top:6px;font-style:italic">* Количество сделок примерное и не всегда соответствует реальности — зависит от рыночных условий</div>
          </div>
        </div>

        <!-- Ключевые показатели -->
        <div style="font-size:11px;font-weight:700;color:rgba(255,255,255,.4);letter-spacing:1.5px;margin-bottom:10px">КЛЮЧЕВЫЕ ПОКАЗАТЕЛИ ПЛАНА</div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:24px">
          ${[
            ...
            <div style="background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:13px">
              <div style="font-size:18px;margin-bottom:5px">${ic}</div>
              <div style="font-size:10px;color:rgba(255,255,255,.3);margin-bottom:3px;text-transform:uppercase;letter-spacing:.05em">${lab}</div>
              <div style="font-size:16px;font-weight:700;color:#fff">${val}</div>
              <div style="font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:2px">${sub}</div>
            </div>`).join('')}
        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:24px">
          ${[
            ['Ф.1 РАЗГОН','Дни 1–17','Закрыть займ из прибыли','100% SWAP','#e53e3e'],
            ['Ф.2 РОСТ','Дни 18–40','Compound growth','85% SWAP / 15% резерв','#d4af37'],
            ['Ф.3 ФИНАЛ','Дни 41–60','Фиксация и вывод','70% SWAP / 30% резерв','#1db954'],
          ].map(([name,period,goal,alloc,color])=>`
            <div style="background:rgba(255,255,255,.03);border:1px solid ${color}28;border-radius:12px;padding:13px;display:flex;align-items:center;gap:12px">
              <div style="width:40px;height:40px;border-radius:11px;background:${color}15;border:1px solid ${color}30;display:flex;align-items:center;justify-content:center;flex-shrink:0">
              ...
              <div style="flex:1">
                ...
                <div style="font-size:11px;color:rgba(255,255,255,.45);margin-top:2px">${period} · ${goal}</div>
                <div style="font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace;margin-top:3px">${alloc}</div>
              </div>
            </div>`).join('')}
        </div>
        ...
        <div style="background:rgba(255,255,255,.02);border:1px solid rgba(255,255,255,.07);border-radius:14px;overflow:hidden;margin-bottom:24px">
          ${[
            ...
            <div style="display:flex;align-items:center;padding:11px 14px;${i>0?'border-top:1px solid rgba(255,255,255,.04)':''}${day.includes('★')?';background:rgba(212,175,55,.05)':''}">
              <div style="width:72px;font-size:11px;font-weight:700;font-family:'JetBrains Mono',monospace;color:${day.includes('★')?'#d4af37':'rgba(255,255,255,.55)'}">${day}</div>
              <div style="flex:1;font-size:10px;color:rgba(255,255,255,.25);font-family:'JetBrains Mono',monospace">${date}</div>
              <div style="font-size:13px;font-weight:700;color:#1db954;font-family:'JetBrains Mono',monospace">${cap}</div>
              ${note?`<div style="margin-left:8px;font-size:9px;background:rgba(212,175,55,.12);border:1px solid rgba(212,175,55,.3);color:#d4af37;padding:2px 7px;border-radius:20px;font-weight:700;white-space:nowrap">${note}</div>`:''}
            </div>`).join('')}
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:24px">
          ${[
            ['Консерв.','4%/день','$25 690','+756%','rgba(255,255,255,.35)'],
            ['Базово','5%/день','$36 987','+1 133%','#d4af37'],
            ['Оптимист.','6%/день','$53 092','+1 670%','#1db954'],
          ].map(([name,rate,cap,roi,color])=>`
            <div style="border-radius:12px;padding:13px;text-align:center;border:1px solid ${name==='Базово'?'rgba(212,175,55,.35)':'rgba(255,255,255,.06)'};background:${name==='Базово'?'rgba(212,175,55,.08)':'rgba(255,255,255,.03)'}">
              <div style="font-size:11px;font-weight:700;color:${color};margin-bottom:5px">${name}</div>
              <div style="font-size:10px;color:rgba(255,255,255,.3);font-family:'JetBrains Mono',monospace;margin-bottom:7px">${rate}</div>
              <div style="font-size:15px;font-weight:800;color:#fff;margin-bottom:3px">${cap}</div>
              <div style="font-size:10px;font-weight:700;color:${color};font-family:'JetBrains Mono',monospace">${roi}</div>
            </div>`).join('')}
        </div>

        <!-- Итог -->
        <div style="background:linear-gradient(135deg,rgba(29,185,84,.12),rgba(29,185,84,.03));border:1px solid rgba(29,185,84,.2);border-radius:18px;padding:20px;text-align:center">
          <div style="font-size:10px;font-family:'JetBrains Mono',monospace;color:rgba(29,185,84,.6);letter-spacing:2px;margin-bottom:10px">ИТОГ · ДЕНЬ 60 · 18.06.2026</div>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:12px">
            <div>
              <div style="font-size:10px;color:rgba(255,255,255,.3);margin-bottom:3px">Итоговый капитал</div>
              <div style="font-size:22px;font-weight:800;color:#1db954;font-family:'JetBrains Mono',monospace">$36 987</div>
            </div>
            <div>
              <div style="font-size:10px;color:rgba(255,255,255,.3);margin-bottom:3px">Чистая прибыль</div>
              <div style="font-size:22px;font-weight:800;color:#d4af37;font-family:'JetBrains Mono',monospace">$33 987</div>
            </div>
          </div>
          <div style="font-size:11px;color:rgba(255,255,255,.35)">Подготовлено для пользователей <span style="color:#d4af37;font-weight:700">RavenEye</span> · Апрель 2026</div>
        </div>
