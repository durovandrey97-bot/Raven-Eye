      ...
      <div class="ti-mid">
        <div>
          <div class="pair-row">
            ...
            <button class="share-btn" data-share-id="${t._id}" title="Поделиться" onclick="event.stopPropagation()">
            ...
            <button class="copy-btn" data-copy="${t.pair||''}" title="Скопировать" onclick="event.stopPropagation()">
