...
function isExpired(t){
  ...
  // Если нет времени создания — прячем fixed сделки через 2 минуты после фиксации
  if(!d){
    if(t.fixed) return true; // нет времени + fixed = скрываем
    return false; // нет времени + не fixed = показываем
  }
