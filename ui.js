    ...
    <div style="width:100%;max-width:480px;max-height:93vh;overflow-y:auto;background:#0d1017;border-radius:24px 24px 0 0;padding:0 0 52px;scrollbar-width:none">
      ...
      <div style="padding:20px 20px 0">
        ...
        <div style="background:rgba(255,255,255,.02);border:1px solid rgba(255,255,255,.07);border-radius:16px;overflow:hidden;margin-bottom:24px">
          ${[
            {day:'СТАРТ',date:'20.04.2026',cap:'$10 000',raw:10000,note:'',star:false},
            {day:'День 10',date:'29.04.2026',cap:'$13 951',raw:13951,note:'',star:false},
            {day:'День 17',date:'06.05.2026',cap:'$10 179',raw:10179,note:'средства возвращены',star:true},
            {day:'День 30',date:'19.05.2026',cap:'$14 804',raw:14804,note:'',star:false},
            {day:'День 40',date:'07.06.2026',cap:'$20 653',raw:20653,note:'Ф.3 старт',star:false},
            {day:'День 60',date:'18.06.2026',cap:'$36 987',raw:36987,note:'финиш 🏆',star:false},
          ].map((p,i,arr)=>{
        ...
        <div style="background:linear-gradient(135deg,rgba(29,185,84,.12),rgba(29,185,84,.03));border:1px solid rgba(29,185,84,.2);border-radius:20px;padding:20px;margin-bottom:20px;text-align:center">
          <div style="font-size:10px;font-family:'JetBrains Mono',monospace;color:rgba(29,185,84,.6);letter-spacing:2px;margin-bottom:12px">ИТОГ · ДЕНЬ 60 · 18.06.2026</div>
          ...
          <div style="font-size:11px;color:rgba(255,255,255,.3)">Подготовлено для пользователей <span style="color:#d4af37;font-weight:700">RavenEye</span> · Апрель 2026</div>
        </div>
