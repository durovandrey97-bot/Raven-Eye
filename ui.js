      ...
      <div style="padding:20px 20px 0">
        ...
        <div style="margin-bottom:24px">
          ...
          ${[
            ...
            {emoji:'🔷',name:'Arbitrum',color:'#29B6F6',rc:'41,182,246',from:'$10K',deals:'+2–3 сигнала/день',vol:'$3M–30M',pct:'~5%',badge:'от $10K',badgeColor:'#29B6F6',badgeRc:'41,182,246',balBefore:'$10 000',balAfter:'$13 000',tip:'Низкие комиссии, высокая скорость. Открывает доступ к новым пулам ликвидности'},
            {emoji:'💎',name:'Ethereum',color:'#818CF8',rc:'99,102,241',from:'$20K',deals:'+1–2 сделки/день',vol:'$8M–50M',pct:'~6%',badge:'от $20K',badgeColor:'#818CF8',badgeRc:'99,102,241',balBefore:'$20 000',balAfter:'$27 200',tip:'Крупнейшие объёмы пулов. Самые высокие спреды и доходность'},
            {emoji:'🟣',name:'Solana',color:'#9945FF',rc:'153,69,255',from:'$15K',deals:'+1–2 сделки/день',vol:'$2M–25M',pct:'~5.5%',badge:'от $15K',badgeColor:'#9945FF',badgeRc:'153,69,255',balBefore:'$15 000',balAfter:'$20 250',tip:'Транзакции за доли секунды. Комиссия ≈ $0 — максимальный чистый доход'},
          ].map((n,i)=>`
        ...
        <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:24px">
          ${[
            {label:'Ф.1',name:'РАЗГОН',period:'Дни 1–17',goal:'Закрыть займ',alloc:'100% SWAP',color:'#e53e3e',rc:'229,62,62',hint:'Берите каждую сделку. Реинвестируйте всё. Цель — выйти в плюс и закрыть займ'},
        ...
        <div style="background:rgba(255,255,255,.02);border:1px solid rgba(255,255,255,.07);border-radius:16px;overflow:hidden;margin-bottom:24px">
          ${[
            ...
            {day:'День 17',date:'06.05.2026',cap:'$10 179',raw:10179,note:'займ закрыт',star:true},
